...
def MagLoss(
    ...
    # no more than 2000
    # if(dataNums>6000):dataNums=6000   Modify by JR
    if(dataNums>10000):dataNums=10000
...
def Mag_plot(material_name,relative_error,save_path="", xlim=None):
    ...
    if save_path!="":
        ...
        plt.savefig(os.path.join(save_path, material_name + ".png"), bbox_inches='tight')
...
>>>>>>>> a1301ba1768d63c1848c26785fda62cff610e62b:MagLearn/MagNet.py

...
class MagLoader:
    ...
    def __init__(self,material_path='',data_type='numpy',data_source=None):
        # # Choose to load .mat or .csv file
        ...
        #         data_source = 'stdd'
        #     else:
        #         raise ValueError("Unsupported file extension or data_source not provided.")
        if material_path!='':
            # print(f'Loading data from {material_path}...')
            if data_source=='mat':
...
if __name__ == '__main__':
    ...
    a = MagLoader(
        ...
        # r"C:\Users\1\Desktop\PHD\Maglearn\test_JR\raw_data\3C90_cycle"
    )
